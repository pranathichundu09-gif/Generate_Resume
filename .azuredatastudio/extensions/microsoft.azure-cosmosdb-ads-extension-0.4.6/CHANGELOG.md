...
## [0.4.3] - 1/19/2024
### New changes
* Use new Query Editor beta 9 version
* Use new build pipeline

## [0.4.4] - 5/14/2024
### Bug fixes
* Fix proxy not spawning when running query editor on noSql container
* Update tar dependency
* Update notices

## [0.4.5] - 7/21/2024
### Bug fixes
* Update signing profiles

## [0.4.6] - 9/18/2024
### Bug fixes
* Download Mongo shell and sample data into global storage folder instead of extension folder where user does not have permissions in the System install configuration