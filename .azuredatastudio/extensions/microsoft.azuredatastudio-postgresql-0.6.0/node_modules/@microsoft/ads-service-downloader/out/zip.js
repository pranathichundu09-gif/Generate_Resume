...
exports.Unzipper = exports.ExtractError = void 0;
...
class Unzipper {
        ...
        return new Promise((c, e) => {
            ...
            zipfile.on('entry', (entry) => {
                ...
                if (/\/$/.test(entry.fileName)) {
                    ...
                    (0, mkdirp_1.default)(targetFileName).then(() => readNextEntry()).then(undefined, e);
                    return;
                }
    ...
    extractEntry(stream, fileName, mode, targetPath, entryNumber, totalEntries) {
        ...
        let istream;
        return Promise.resolve((0, mkdirp_1.default)(targetDirName)).then(() => new Promise((c, e) => {
            try {
                istream = (0, fs_1.createWriteStream)(targetFileName, { mode });
                istream.once('close', () => {
                    this.eventEmitter.emit("entry_extracted" /* Events.ENTRY_EXTRACTED */, targetFileName, entryNumber, totalEntries);
                    c();
                });
