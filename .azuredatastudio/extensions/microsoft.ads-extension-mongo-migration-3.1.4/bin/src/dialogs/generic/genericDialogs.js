...
exports.ShowStatusMessageDialog = void 0;
const azdata = require("azdata");
const constants = require("../../constants/strings");
function ShowStatusMessageDialog(title, statusMessage, errorMessage) {
    ...
    tab.registerContent(async (view) => {
        ...
        if (errorMessage.length > 0) {
            flex.addItem(view.modelBuilder.inputBox()
                .withProps({
                value: errorMessage,
                readOnly: true,
                multiline: true,
    ...
    const dialog = azdata.window.createModelViewDialog(title, 'messageDialog', 450, 'normal');
    dialog.content = [tab];
...
exports.ShowStatusMessageDialog = ShowStatusMessageDialog;
//# sourceMappingURL=genericDialogs.js.map